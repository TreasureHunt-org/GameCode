...
using Cinemachine;
using UnityEngine.Rendering.Universal;  // Make sure to include the Cinemachine namespace
using UnityEngine.UI;
using TMPro;

public class WallJumpBallSpawner : MonoBehaviour
{
    ...
    {
        testingMovement.WalljumpForce = 10;
